...
import net.mastersloth.slothee.procedures.CoffeeMachineOnBlockRightClickedProcedure;
...
public class CoffeeMachineBlock extends SlotheeModElements.ModElement {
	@ObjectHolder("slothee:coffee_machine")
	public static final Block block = null;
	@ObjectHolder("slothee:coffee_machine")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CoffeeMachineBlock(SlotheeModElements instance) {
		super(instance, 1);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(CoffeeMachineBlock.block);
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				CoffeeMachineOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		private final EnergyStorage energyStorage = new EnergyStorage(420000, 6900, 200, 0) {
			@Override
