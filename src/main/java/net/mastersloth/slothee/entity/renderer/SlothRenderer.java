...
public class SlothRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SlothEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelplayer(), 1f) {
					@Override
	...
	public static class Modelplayer extends EntityModel<Entity> {
		...
		public Modelplayer() {
			...
			bb_main.setTextureOffset(16, 48).addBox(0.0F, -12.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
			bb_main.setTextureOffset(16, 16).addBox(-4.0F, -24.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.0F, false);
			bb_main.setTextureOffset(32, 48).addBox(-8.0F, -24.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
			bb_main.setTextureOffset(40, 16).addBox(4.0F, -24.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
