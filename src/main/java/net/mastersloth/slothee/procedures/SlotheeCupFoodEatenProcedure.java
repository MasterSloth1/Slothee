...
public class SlotheeCupFoodEatenProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SlotheeMod.LOGGER.warn("Failed to load dependency entity for procedure SlotheeCupFoodEaten!");
			return;
		}
		...
		if (entity instanceof LivingEntity)
			((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.NIGHT_VISION, (int) 60, (int) 3, (false), (false)));
		if (entity instanceof LivingEntity)
